...
Interested in Agentic AI, AI Safety & Alignment, Multi-Agent Systems, Reinforcement Learning, AI Memory, NLP, Deep Learning and Post Training
...
- **[Speech World Model](https://github.com/YashDThapliyal/HuPER-speech-world-model)** - Syllable-clocked world model for Speech combining GRU belief propagation and WavLM for predictive speech perception inspired by human listening dynamics
